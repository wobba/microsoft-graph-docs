...
-->
``` http
PATCH /termStores/{termStoresId}/groups/{groupId}/sets/{setId}/children
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/termStores/{termStoresId}/groups/{groupId}/sets/{setId}/children
